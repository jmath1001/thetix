  ...
  const handleConfirmBooking = async (data: any) => {
    await bookStudent({
      ...
      student: {
        ...
        parent_name: student.parent_name ?? student.mom_name ?? student.dad_name ?? null,
        parent_email: student.parent_email ?? student.mom_email ?? student.dad_email ?? null,
        parent_phone: student.parent_phone ?? student.mom_phone ?? student.dad_phone ?? null,
